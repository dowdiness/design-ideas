...
.search--box:hover > .search--box__text {
  width: 240px;
  margin-left: 16px;
  background: #2d3748;
}

.search--box:hover > .search--box__link {
  background: #fff;
}
...
export default {
  head: {
    link: [
      {href: "https://fonts.googleapis.com/css?family=Montserrat&display=swap" , ref: "stylesheet"}
    ],
    script: [
      { src: "https://kit.fontawesome.com/b0a08ceecb.js" }
    ]
  }
}
</script>
